...
public class Entity : MonoBehaviour {
	...
	public virtual bool CheckPlayerInDashAgroRange() {
		return Physics2D.Raycast(playerCheck.position, transform.right, entityData.dashAgroDistance, entityData.whatIsPlayer);
	}
	...
	public virtual void OnDrawGizmos() {
		if (Core != null) {
			...
			Gizmos.DrawWireSphere(playerCheck.position + (Vector3)(Vector2.right * entityData.dashAgroDistance), 0.2f);
		}
	}
}